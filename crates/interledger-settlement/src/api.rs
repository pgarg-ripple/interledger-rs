...
pub fn scale_with_precision_loss(
    ...
    // It's safe to unwrap here since BigUint's normalize_scale
    // [cannot fail](https://github.com/interledger-rs/interledger-rs/blob/master/crates/interledger-settlement/src/lib.rs#L154-L165)
    let scaled = amount
