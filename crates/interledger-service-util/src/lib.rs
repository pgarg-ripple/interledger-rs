...
mod tests {
    ...
    fn u64_test() {
        ...
        assert_eq!(1u64.normalize_scale(1, 1), 1);
        ...
        assert_eq!(1u64.normalize_scale(1, 2), 0);
        assert_eq!(10u64.normalize_scale(1, 2), 1);
        // 100 units with base 2 is 10 units with base 3
        assert_eq!(100u64.normalize_scale(2, 3), 10);
    ...
    fn f64_test() {
        // 1 unit with base 1, is 1 unit with base 1
        assert_eq!(1f64.normalize_scale(1, 1), 1.0);
        // 1 unit with base 10, is 10 units with base 1
        ...
        assert_eq!(10f64.normalize_scale(1, 2), 1.0);
        // 100 units with base 2 is 10 units with base 3
        assert_eq!(100f64.normalize_scale(2, 3), 10.0);
        // 299 units with base 2 is 10 units with base 3 plus 99 leftovers
        assert_eq!(100f64.normalize_scale(2, 3), 10.0);

        assert_eq!(999f64.normalize_scale(6, 9), 0.999);
        assert_eq!(1000f64.normalize_scale(6, 9), 1.0);
        assert_eq!(1999f64.normalize_scale(6, 9), 1.999);
    }
}
